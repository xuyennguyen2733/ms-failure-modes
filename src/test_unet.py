...
Metrics are written incrementally to eval_reports/unet_eval_log_<timestamp>.txt
...
parser.add_argument('--model_label', type=str, default='unet',
    ...
    with Parallel(n_jobs=args.n_jobs) as parallel_backend:
        with torch.no_grad():
            for count, batch_data in enumerate(val_loader):
                ...
                # Log the subject row incrementally (scaled to match summary)
